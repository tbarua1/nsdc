...
<style>
        ...
        <div id="left">
            ...
            <a href="addBatchSchedule.jsp" target="iframe_a">Create Administrator </a><br>            
            <a href="addTrainer.jsp" target="iframe_a">Create Trainer</a><br>
            <a href="addBatchCode.jsp" target="iframe_a">Create Batch</a>  
            <a href="addBatchSchedule.jsp" target="iframe_a">Schedule Batch</a>  
            <a href="addDistrict.jsp" target="iframe_a">Add District</a>  
            <a href="addJobRole.jsp" target="iframe_a">Add Job Role</a>  
            <a href="register.jsp" target="iframe_a">Common Register</a>  
