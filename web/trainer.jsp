...
<html>
    <head>
        <%
            ...
            List<Trainer> loginCheckAdmin = (List<Trainer>) session.getAttribute("informationPartner");
            Trainer data = loginCheckAdmin.get(0);
            session.getAttribute("usertype");
        %>

        <title>Welcome Trainer<%=session.getAttribute("username")%></title>
    ...
    <body>
        ...
        <div id="header">Welcome Trainer</div>
        <div id="left">
            <a href="addBatchCode.jsp" target="iframe_a">Add Batch(if required)</a><br>
            <a href="addBatchSchedule.jsp" target="iframe_a">Add Batch Schedule</a><br>            
            <a href="trainer.html" target="iframe_a">Download Trainer App</a><br>   
