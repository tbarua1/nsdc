...
<html>
    <head>
        <title>Register Training Partner</title>
        <meta charset="UTF-8">
...
//                        list.get
    ...
    <body>
    <center><h1>Register Training Partner</h1></center>
    <form name="registerForm" role="form" action="AddTrainingPartner" method="post" onsubmit="return validateForm()">
        <center><table>
                ...
                <tr>
                    <td><label class="label-control-a">Spoc Name:</label></td>
                ...
                <tr>
                    ...
                    <td><input type="submit" name="" id="btnlogin" class="btn-3" value="Login" style="float: right;" onclick="formValidation();"></td>
                </tr>
            </table>
        </center>
    </form>
