...
public class JobRole implements Serializable {
    ...
    public void setIndustry_visit(Integer industry_visit) {
        this.industry_visit = industry_visit;
    }
    ...
    public int hashCode() {
        ...
        hash = 97 * hash + Objects.hashCode(this.ssc);
        hash = 97 * hash + Objects.hashCode(this.name);
        hash = 97 * hash + Objects.hashCode(this.qp_code);
        hash = 97 * hash + Objects.hashCode(this.industry_type);
        hash = 97 * hash + Objects.hashCode(this.training_type);
        hash = 97 * hash + Objects.hashCode(this.industry_visit);
        hash = 97 * hash + Objects.hashCode(this.nsqf_level);
        hash = 97 * hash + Objects.hashCode(this.theory);
        hash = 97 * hash + Objects.hashCode(this.practical);
        hash = 97 * hash + Objects.hashCode(this.aditional_duration);
        hash = 97 * hash + Objects.hashCode(this.degital_literacy);
        hash = 97 * hash + Objects.hashCode(this.total_hours);
        hash = 97 * hash + Objects.hashCode(this.paid);
        return hash;
    }
    ...
    public String toString() {
        return "JobRole{" + "id=" + id + ", ssc=" + ssc + ", name=" + name + ", qp_code=" + qp_code + ", industry_type=" + industry_type + ", training_type=" + training_type + ", industry_visit=" + industry_visit + ", nsqf_level=" + nsqf_level + ", theory=" + theory + ", practical=" + practical + ", aditional_duration=" + aditional_duration + ", degital_literacy=" + degital_literacy + ", total_hours=" + total_hours + ", paid=" + paid + '}';
    }
