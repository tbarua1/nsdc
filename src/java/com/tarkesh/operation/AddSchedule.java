...
public class AddSchedule extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("i am at AddSchedule");
        String parameter = request.getParameter("university");
        String parameter1 = request.getParameter("trainer");
        String parameter2 = request.getParameter("batchcode");
        response.setContentType("text/html;charset=UTF-8");
        try (PrintWriter out = response.getWriter()) {
            /* TODO output your page here. You may use following sample code. */
              BatchSchedule batchCodes=new BatchSchedule();
              batchCodes.setUniversity(parameter);
              batchCodes.setTrainer(parameter1);
              batchCodes.setComment(parameter2);
            /* TODO output your page here. You may use following sample code. */
            Operations.addBatchSchedule(batchCodes);
